...
export async function detectCapabilities(): Promise<Capability[]> {
  ...
  return [
    ...
    { key: "canvas", label: "Canvas", supported: typeof document !== "undefined" && Boolean(document.createElement("canvas").getContext("2d")), recovery: "This browser cannot create the canvas used for video frames." },
