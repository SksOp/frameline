...
import { StudioEyebrow, type StudioEyebrowTone } from "./studio-eyebrow";
  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="max-w-[17ch] font-display text-[clamp(3rem,8vw,7rem)] font-[560] leading-[0.92] tracking-[-0.05em]" id={titleId}>{title}</h1>
